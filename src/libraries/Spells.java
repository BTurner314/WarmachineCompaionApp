...
public class Spells {
	...
	public static Spells fortify = new libraries.Spells("Fortify", 2, "6", "0", 0, "UP", false, "Target warjack in the spellcaster's battlegroup gains +2ARM. The affected model and any friendly model B2B with it cannot become knocked down, be pushed, or be moved by a slam.");
	...
	public static Spells immolation = new libraries.Spells("Immolation", 2, "8", "0", 12, "0", true, "Immolation causes fire damage. On a critical hit, the model hit suffers the Fire continuous effect.");
